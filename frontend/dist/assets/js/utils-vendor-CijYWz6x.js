      ...
      : D
        ? ((q = `axios@${Math.random()}`),
          ...
          x.addEventListener(
            'message',
            ({ source: e, data: t }) => {
              e === x && t === q && M.length && M.shift()();
            },
            !1,
          ),
          e => {
            (M.push(e), x.postMessage(q, '*'));
          })
        : e => setTimeout(e));
var B, D, q, M;
const I =
  ...
  z = {
    ...
    forEach: v,
    merge: function e() {
      const { caseless: t, skipUndefined: n } = (C(this) && this) || {},
        r = {},
        o = (o, s) => {
          const i = (t && j(r, s)) || s;
          b(r[i]) && b(o)
...
const X = z.toFlatObject(z, {}, null, function (e) {
...
function G(e, t, n) {
  ...
  const u = [],
    f = Object.assign(X, { defaultVisitor: l, convertValue: c, isVisitable: K });
    ...
    function (e, t) {
      ...
      if (o) {
        if (n.indexOf('application/x-www-form-urlencoded') > -1)
          return (function (e, t) {
            return G(e, new ue.classes.URLSearchParams(), {
        ...
        if ((s = z.isFileList(e)) || n.indexOf('multipart/form-data') > -1) {
          ...
          return G(s ? { 'files[]': e } : e, t && new t(), this.formSerializer);
        }
      }
      return o || r
...
const Ce = e => (e instanceof ge ? { ...e } : e);
function Ne(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n, r) {
...
const Pe = e => {
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        (m.open(r.method.toUpperCase(), r.url, !0),
          ...
          h && (([c, u] = Se(h, !0)), m.addEventListener('progress', c)),
          d &&
            m.upload &&
            (([a, l] = Se(d)),
  ...
  { ReadableStream: qe, TextEncoder: Me } = z.global,
  Ie = (e, ...t) => {
    try {
      return !!e(...t);
    } catch (n) {
  ...
  ze = e => {
    ...
    const a = o && Be(qe),
      ...
      u = i && a && Ie(() => z.isReadableStream(new r('').body)),
      f = { stream: u && (e => e.body) };
    o &&
    ...
    return async e => {
      ...
      let R = Fe([c, h && h.toAbortSignal()], p),
        S = null;
      const T =
        R &&
        R.unsubscribe &&
      ...
      try {
        ...
        if (u && (m || (p && T))) {
          ...
          const t = z.toFiniteNumber(h.headers.get('content-length')),
        ...
        y = y || 'text';
        let v = await f[z.findKey(f, y) || 'text'](h, e);
        return (
          !p && T && T(),
          await new Promise((t, n) => {
            Re(t, n, {
              data: v,
              headers: ge.from(h.headers),
              status: h.status,
...
Je();
const We = { http: null, xhr: Ue, fetch: { get: Je } };
z.forEach(We, (e, t) => {
  if (e) {
    try {
...
((st.Axios = nt),
  ...
  (st.mergeConfig = Ne),
  (st.AxiosHeaders = ge),
  (st.formToJSON = e => fe(z.isHTMLForm(e) ? new FormData(e) : e)),
  (st.getAdapter = $e),
