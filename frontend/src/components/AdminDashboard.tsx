    ...
    <div className={`min-h-screen p-6 ${
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Qylon Admin Dashboard</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          <div className={`p-6 rounded-xl border ${
            ...
            <div className="flex items-center gap-2 md:gap-3 mb-2">
              ...
              <span className="font-semibold text-sm md:text-base">Total Signups</span>
            </div>
            <div className="text-2xl md:text-3xl font-bold text-cyan-500">{stats.total}</div>
          </div>
          ...
          <div className={`p-6 rounded-xl border ${
            ...
            <div className="text-2xl md:text-3xl font-bold text-green-500">{stats.today}</div>
          </div>
          ...
          <div className={`p-6 rounded-xl border ${
            ...
            <div className="flex items-center gap-2 md:gap-3 mb-2">
              ...
              <span className="font-semibold text-sm md:text-base">Hero Form</span>
            </div>
            <div className="text-2xl md:text-3xl font-bold text-purple-500">{stats.hero}</div>
          </div>
          ...
          <div className={`p-6 rounded-xl border ${
            ...
            <div className="flex items-center gap-2 md:gap-3 mb-2">
              ...
              <span className="font-semibold text-sm md:text-base">Final CTA</span>
            </div>
            <div className="text-2xl md:text-3xl font-bold text-orange-500">{stats.finalCta}</div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className={isDark ? 'bg-gray-800' : 'bg-gray-50'}>
                <tr>
                  <th className="px-4 md:px-6 py-3 md:py-4 text-left font-semibold text-sm md:text-base">Email</th>
                  <th className="px-4 md:px-6 py-3 md:py-4 text-left font-semibold text-sm md:text-base">Source</th>
              ...
              <tbody>
                {entries.map((entry) => (
                  <tr key={entry.id} className={`border-b ${
                    ...
                    <td className="px-4 md:px-6 py-3 md:py-4 text-sm md:text-base">{entry.email}</td>
            ...
            {entries.length === 0 && (
              <div className="p-12 text-center">
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-2">No entries yet</h3>
