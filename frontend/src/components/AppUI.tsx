        ...
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 lg:mb-8'>
          ...
          <div className='flex space-x-2 lg:space-x-3'>
            ...
            <button
              className={`p-2 lg:p-3 rounded-lg lg:rounded-xl ${glassCard} hover:scale-110 transition-transform`}
            >
              <Icon name="headphones" size={24} className='w-4 lg:w-6 h-4 lg:h-6 text-emerald-500' />
            </button>
          </div>
        </div>
          ...
          {[
            ...
            >
              <div className='flex items-center justify-between mb-3 lg:mb-4'>
                <Icon name={stat.icon as any} size={32} className='w-6 lg:w-8 h-6 lg:h-8 text-blue-500' />
                {stat.trend === 'up' && <Icon name="trendingUp" size={16} className='w-4 h-4 text-emerald-500' />}
              </div>
              <div
          ...
          >
            ...
            >
              ...
              <div className='flex items-center justify-between mb-4'>
                ...
                >
                  {isRecording ? <Icon name="pause" size={20} className='w-5 h-5' /> : <Icon name="play" size={20} className='w-5 h-5' />}
                </button>
              </div>
