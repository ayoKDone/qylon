  ...
  const DashboardView = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 h-full">
      ...
      >
        ...
        {/* Live Processing */}
        <div
          className={`p-4 lg:p-6 rounded-xl lg:rounded-2xl mb-6 lg:mb-8 ${glassCard}`}
        >
          <div className="flex items-center space-x-3 lg:space-x-4 mb-4 lg:mb-6">
            ...
            <div>
              ...
              <p
                className={`text-sm lg:text-base ${isDark ? 'text-slate-400' : 'text-slate-600'}`}
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
          {[
            ...
            >
              ...
              <div
                className={`text-xs lg:text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`}
              >
                {stat.label}
              </div>
        ...
        <div className={`p-4 lg:p-6 rounded-2xl lg:rounded-3xl ${glassPanel}`}>
          ...
          <div className="space-y-3 lg:space-y-4">
            {[
              ...
              <div
                key={index}
                className={`p-3 lg:p-4 rounded-xl lg:rounded-2xl ${glassCard}`}
              >
                <p
    ...
    switch (activeTab) {
      ...
      case 'tasks':
        return (
          <SimpleView
            title="Action Items"
            description="Manage all extracted action items"
          />
        );
      case 'analytics':
        return (
          <SimpleView
            title="Analytics"
            description="Track your meeting efficiency metrics"
          />
        );
      case 'calendar':
        return (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {activeTab === 'meetings' &&
                        'Monitor and control all live conversations'}
                      {activeTab === 'tasks' &&
                        'Manage all extracted action items'}
                      {activeTab === 'analytics' &&
                        'Track your meeting efficiency metrics'}
                      {activeTab === 'calendar' &&
