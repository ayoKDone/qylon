  ...
  const faqs = [
    {
      ...
      answer: "Our AI has been trained specifically for business conversations and achieves 95%+ accuracy in identifying action items, assignees, and deadlines."
    },
    {
      question: "Does it work with our existing PM tools?",
      answer: "Yes! We integrate seamlessly with ClickUp, Asana, and Monday.com. Tasks appear in your existing projects and workflows."
    },
    {
      question: "Is my meeting data secure?",
      answer: "Absolutely. All data is encrypted in transit and at rest. We're SOC 2 compliant and never store recordings longer than necessary for processing."
    },
    {
      question: "What if I have both virtual and in-person meetings?",
      answer: "Qylon handles both! Use our meeting bot for virtual calls and our mobile app for in-person conversations."
    },
    {
      question: "Can I customize how tasks are created?",
      answer: "Yes, you can set rules for task assignment, project placement, priority levels, and more through our dashboard."
    }
  ];
