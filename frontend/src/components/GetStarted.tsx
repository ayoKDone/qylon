    ...
    <section className='xui-d-grid md:grid-cols-2 min-h-screen'>
      ...
      <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-center p-12 bg-white'>
        <div className='max-w-md text-center'>
          ...
          <h1 className='text-3xl font-bold mb-4'>Transform Your Meetings with AI</h1>
          <p className='text-gray-600 mb-6'>
            Qylon automatically captures, processes, and transforms your meeting content into
            actionable business assets using advanced AI workflows.
          </p>
