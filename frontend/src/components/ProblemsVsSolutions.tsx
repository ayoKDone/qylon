            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className={`p-4 md:p-6 rounded-xl border ${
                  ...
                  <div className={`text-base md:text-lg font-medium mb-4 italic ${
              ...
              <div className="flex justify-center my-4 md:my-6">
                <div className="text-4xl bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">↓</div>
              </div>
            </div>
          ))}
        </div>
