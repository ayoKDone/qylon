  ...
  return (
    <section className={`py-24 relative overflow-hidden transition-colors duration-300 ${
      ...
      <div className="absolute inset-0">
        ...
        <div className={`absolute top-0 left-1/2 transform -translate-x-1/2 w-[1000px] h-[1000px] bg-gradient-radial rounded-full ${
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          {/* Main ROI Container */}
          <div className={`relative p-12 rounded-3xl border backdrop-blur-xl ${
            isDark 
            ...
            {/* Glow Effect */}
            <div className={`absolute -inset-1 bg-gradient-to-r rounded-3xl blur-xl opacity-50 ${
              isDark ? 'from-cyan-500/20 via-purple-500/20 to-cyan-500/20' : 'from-cyan-500/30 via-purple-500/30 to-cyan-500/30'
            }`}></div>
            ...
            <div className="relative">
              ...
              <div className="text-center mb-12">
                ...
                <p className={`text-xl max-w-3xl mx-auto ${
                  ...
                  Stop wasting time on manual task creation and follow-ups. 
                  Let AI handle the busywork while you focus on what drives real business value.
                </p>
              </div>
