  ...
  return (
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 48 48">
        ...
        35.091,26.715,36,24,36c-5.202,0-9.619-3.317,
        -11.283-7.946l-6.522,5.025C9.505,39.556,
        16.227,44,24,44z"></path>
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303
        c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,
