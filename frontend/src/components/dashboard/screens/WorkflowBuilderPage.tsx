      ...
      <div className='flex-1 flex overflow-hidden'>
        ...
        <div className='w-65 bg-gray-50 border-r border-gray-200 p-6 overflow-y-auto'>
          <div className='space-y-6'>
            <WorkflowSidebar title='Triggers' items={triggers} onDragStart={handleDragStart} />
            <WorkflowSidebar title='Actions' items={actions} onDragStart={handleDragStart} />
            <WorkflowSidebar title='Conditions' items={conditions} onDragStart={handleDragStart} />
          </div>
        </div>
