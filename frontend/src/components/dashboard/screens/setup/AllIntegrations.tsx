    ...
    <>
      <div className="xui-text-center xui-max-w-500 xui-w-fluid-100 xui-mx-auto">
        ...
        <p className="xui-font-sz-[15px] xui-mt-half xui-opacity-6">
          Select the platform you'll like Qylon to connect with.
        </p>
      </div>
      <section className="xui-container xui-mt-2 xui-p-1 xui-d-grid xui-grid-col xui-md-grid-col-3 xui-lg-grid-col-3 xui-grid-gap-1">
        <div className="xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1 xui-bdr-rad-1">
          ...
          <p className="xui-opacity-6 xui-font-sz-[13px]">
            ...
            ratione asperiores consequatur.
          </p>
        </div>
        <div className="xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1 xui-bdr-rad-1">
          <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between">
          ...
          <h2 className="xui-font-sz-[18px] xui-mt-1 xui-font-w-600">
            Microsoft
          </h2>
          <p className="xui-opacity-6 xui-font-sz-[13px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos magni
        ...
        <div className="xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1 xui-bdr-rad-1">
          ...
          <h2 className="xui-font-sz-[18px] xui-mt-1 xui-font-w-600">Asana</h2>
          <p className="xui-opacity-6 xui-font-sz-[13px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos magni
            ratione asperiores consequatur.
          </p>
        ...
        <div className="xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1 xui-bdr-rad-1">
          <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQw1eP08uvJwgm_J8ngyQPaOeth4Q0WdtjCOQ&s"
              alt="Zoom Logo"
              width={520}
              height={520}
              className="xui-img-40 xui-h-auto"
        ...
        <div className="xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1 xui-bdr-rad-1">
          <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbSZO83zI-GPymbNskVUqKRBZCsy5rRFT8bA&s"
              alt="Zoom Logo"
              width={520}
              height={520}
              className="xui-img-40 xui-h-auto"
          ...
          <h2 className="xui-font-sz-[18px] xui-mt-1 xui-font-w-600">Monday</h2>
          <p className="xui-opacity-6 xui-font-sz-[13px]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos magni
            ratione asperiores consequatur.
          </p>
