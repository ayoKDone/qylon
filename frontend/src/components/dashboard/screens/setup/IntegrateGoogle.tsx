...
import { ArrowLeftIcon, ArrowRightIcon, BotIcon, CheckCircleIcon, Clock12Icon, ShieldAlertIcon } from 'lucide-react';
  ...
  return (
    ...
    <section className='xui-box-shadow-1 xui-py-2 xui-px-1 xui-md-px-3'>
      <div className='xui-text-center'>
        ...
        <p className='text-[15px] xui-mt-half xui-w-fluid-80 xui-mx-auto xui-opacity-7'>Never miss a meeting recording opportunity</p>
      </div>
      ...
      <div className='xui-d-grid xui-grid-col-1 xui-grid-gap-1'>
        <div className='bg-gradient-to-r from-[#EFF6FF] to-[#FAF5FF] xui-bdr-rad-half xui-p-1 xui-d-flex xui-flex-wrap-nowrap xui-grid-gap-1'>
          ...
          <div>
            ...
            <p className="mt-[4px] xui-opacity-6 text-[14px]">Automatically identify upcoming meetings</p>
          </div>
        </div>
        <div className='bg-gradient-to-r from-[#EFF6FF] to-[#FAF5FF] xui-bdr-rad-half xui-p-1 xui-d-flex xui-flex-wrap-nowrap xui-grid-gap-1'>
          <div style={{
          ...
          <div>
            ...
            <p className="mt-[4px] xui-opacity-6 text-[14px]">Join meetings and start recording seamlessly</p>
          </div>
        </div>
        <div className='bg-gradient-to-r from-[#EFF6FF] to-[#FAF5FF] xui-bdr-rad-half xui-p-1 xui-d-flex xui-flex-wrap-nowrap xui-grid-gap-1'>
          <div style={{
          ...
          <div>
            ...
            <p className="mt-[4px] xui-opacity-6 text-[14px]">Ensure all important conversations are captured</p>
          </div>
        </div>
      </div>
      <div className='xui-mt-2 bg-[#F0FDF4] text-[#0D542B] xui-bdr-rad-half xui-p-1 xui-d-flex xui-flex-wrap-nowrap xui-grid-gap-1'>
        ...
        <div>
          ...
          <p className="xui-opacity-6 text-[14px]">We only access meeting metadata. Your calendar events and personal information remain private and secure.</p>
        </div>
      </div>
      {!isConnected ? (
        <button
