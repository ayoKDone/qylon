...
export default function MeetingCard({ meeting, onView, onDownload, onShare }: MeetingCardProps) {
  ...
  const platformColor =
    platformConfig[meeting.platform.toLowerCase()]?.color || platformConfig['default'].color;
      ...
      <div className='flex items-start gap-4'>
        ...
        <div className='flex gap-3'>
          <div className='flex flex-col items-center min-w-[60px]'>
            <div className='text-xl font-semibold text-gray-900'>{meeting.time}</div>
        ...
        <div className='flex-1 min-w-0'>
          ...
          <div className='flex items-center gap-4 text-xs text-gray-600 mb-3'>
            ...
            <div className='flex items-center gap-1.5'>
              {platform.icon ? (
                <img src={platform.icon} alt={meeting.platform} className='w-4 h-4 rounded' />
              ) : (
