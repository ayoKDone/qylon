          ...
          <div className='xui-d-flex xui-grid-gap-1 xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid xui-bdr-fade'>
            ...
            <div>
              ...
              <div className='xui-form-box xui-d-flex xui-lg-flex-jc-flex-end'>
                <button type='submit' disabled={isSubmitting} className='xui-btn xui-btn-blue xui-bdr-rad-half'>
        ...
        <section style={{
          ...
          <div className='xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid xui-bdr-fade'>
            ...
            <div className='xui-d-grid xui-grid-col-1 xui-grid-gap-1-half xui-mt-1'>
              <Link to={'/'} className='xui-opacity-7 xui-d-flex xui-flex-ai-center xui-grid-gap-half'>
                <KeyIcon size={16} />
              ...
              <Link to={'/'} className='xui-text-danger xui-d-flex xui-flex-ai-center xui-grid-gap-half'>
                <Trash2Icon size={16} />
          ...
          <div className='xui-p-1 xui-bdr-rad-half xui-bdr-w-1 xui-bdr-s-solid xui-bdr-blue xui-bg-light-blue-1 xui-text-blue xui-mt-1'>
            <div className='xui-d-flex xui-flex-wrap-nowrap xui-grid-gap-1'>
              ...
              <div style={{
                ...
                <p className='text-[13px] xui-w-fluid-90 xui-mt-half'>Connect your favorite tools to streamline your workflow and boost productivity.</p>
              </div>
            </div>
          </div>
        </section>
    ...
    <section className='xui-mt-4'>
      <div className='xui-d-flex xui-flex-jc-space-between'>
        <div>
          ...
          <span className='xui-opacity-6 text-[14px]'>Connect your favorite tools and services</span>
        </div>
      ...
      <div className='xui-d-grid xui-grid-col-1 xui-lg-grid-col-3 xui-grid-gap-1 xui-mt-1'>
          ...
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://logosandtypes.com/wp-content/uploads/2020/11/Asana.png" alt="Asana Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-badge-success'>Connected</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>Asana</h3>
            <p className='xui-opacity-6 text-[14px]'>Sync tasks and projects with your Asana workspace for seamless project management.</p>
          </div>
        ...
        <div className='xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-bdr-rad-half xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1'>
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://media.tychesoftwares.com/wp-content/uploads/logo_ZM_wordmark_whitesquare-RGB.jpg" alt="Zoom Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-badge-success'>Connected</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>Zoom</h3>
            <p className='xui-opacity-6 text-[14px]'>Schedule and join Zoom meetings directly from your dashboard.</p>
          </div>
          <button className='xui-mt-1 xui-btn xui-btn-block xui-bg-light xui-bdr-rad-half'>
            <span className='text-[13px]'>Manage Connection</span>
          </button>
        ...
        <div className='xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-bdr-rad-half xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1'>
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://thumbs.dreamstime.com/b/google-meet-logo-editorial-illustrative-white-background-logo-icon-vector-logos-icons-set-social-media-flat-banner-vectors-svg-210443207.jpg" alt="Google Meet Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-bg-light'>Available</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>Google Meet</h3>
            <p className='xui-opacity-6 text-[14px]'>Integrate with Google Meet for video conferencing and calendar sync.</p>
          </div>
        ...
        <div className='xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-bdr-rad-half xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1'>
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://www.howtobuysaas.com/wp-content/uploads/2020/10/unnamed-3.png" alt="Zoho Meet Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-bg-light'>Available</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>Zoho Meet</h3>
            <p className='xui-opacity-6 text-[14px]'>Connect with Zoho Meet for secure video conferencing and collaboration.</p>
          </div>
          <button className='xui-mt-1 xui-btn xui-btn-block xui-btn-blue xui-bdr-rad-half'>
            <span className='text-[13px]'>Connect Now</span>
          </button>
        ...
        <div className='xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-bdr-rad-half xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1'>
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://pbs.twimg.com/profile_images/1954978523732643842/TCyGfr9i_400x400.jpg" alt="ClickUp Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-badge-success'>Connected</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>ClickUp</h3>
            <p className='xui-opacity-6 text-[14px]'>Sync your ClickUp tasks and track productivity across all projects.</p>
          </div>
          <button className='xui-mt-1 xui-btn xui-btn-block xui-bg-light xui-bdr-rad-half'>
            <span className='text-[13px]'>Manage Connection</span>
          </button>
        ...
        <div className='xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-bdr-rad-half xui-bdr-fade xui-bdr-w-1 xui-bdr-s-solid xui-p-1'>
          <div>
            <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
              <div className='xui-bg-light w-[40px] h-[40px] xui-bdr-rad-half'>
                <img src="https://thumbs.dreamstime.com/b/slack-logo-vector-white-background-slack-logo-vector-white-background-editorial-illustrative-social-media-logo-206665964.jpg" alt="Slack Logo" width={50} height={50} className='xui-w-fluid-100 xui-h-auto' />
              </div>
              <span className='xui-badge xui-badge-success'>Connected</span>
            </div>
            <h3 className='xui-font-w-600 xui-mt-1'>Slack</h3>
            <p className='xui-opacity-6 text-[14px]'>Get notifications and updates directly in your Slack channels</p>
          </div>
          <button className='xui-mt-1 xui-btn xui-btn-block xui-bg-light xui-bdr-rad-half'>
            <span className='text-[13px]'>Manage Connection</span>
          </button>
