...
async def generate_ai_content(content_request: ContentRequest, current_user: dict) -> str:
    ...
    try:
        ...
        if content_request.content_type == "article":
            ...
            ## Introduction
            In today's fast-paced world, {content_request.topic} has become increasingly important for {content_request.target_audience}. This comprehensive guide will explore the key aspects and provide actionable insights.
