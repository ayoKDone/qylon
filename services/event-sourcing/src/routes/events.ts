...
router.get('/aggregate/:aggregateId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
// Get events by type
router.get('/type/:eventType', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get('/types', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = (req as any).user?.id;
