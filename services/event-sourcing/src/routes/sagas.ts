...
// Get saga by ID
router.get('/:sagaId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get('/correlation/:correlationId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
// Get sagas by status
router.get('/status/:status', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
router.post('/:sagaId/steps/:stepId/execute', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
...
// Compensate a saga
router.post('/:sagaId/compensate', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const { sagaId } = req.params;
    const userId = (req as any).user?.id;
...
router.get('/definitions', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = (req as any).user?.id;
