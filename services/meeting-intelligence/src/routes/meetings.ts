 ...
 */
router.post('/', requireClientAccess, asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.get('/client/:clientId', requireClientAccess, asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.get('/:meetingId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 * Update a meeting
 */
router.put('/:meetingId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const { meetingId } = req.params;
    const userId = (req as any).user?.id;
    ...
    if (updateData.metadata) updatePayload.metadata = { ...existingMeeting.metadata, ...updateData.metadata };
 ...
 * Delete a meeting
 */
router.delete('/:meetingId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const { meetingId } = req.params;
    const userId = (req as any).user?.id;
