 ...
 */
router.get('/:workflowId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 * Update a workflow
 */
router.put('/:workflowId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const { workflowId } = req.params;
    const userId = (req as any).user?.id;
 ...
 * Delete a workflow
 */
router.delete('/:workflowId', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  try {
    const { workflowId } = req.params;
    const userId = (req as any).user?.id;
